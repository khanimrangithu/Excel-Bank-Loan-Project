...
**Objective:** This column chart will represent lending metrics categorized by state, enabling us to find most applications which applied for loans by different states people.
